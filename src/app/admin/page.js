...
const AnalyticsPage = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700 min-h-screen flex flex-col items-center text-white">
      <h1 className="text-3xl font-bold text-center mb-2">Analytics Dashboard</h1>
      <div className="overflow-x-auto w-full max-w-4xl bg-white shadow-lg rounded-lg p-4 mb-8">
        {loading ? (
